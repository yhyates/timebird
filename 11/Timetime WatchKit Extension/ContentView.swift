...
struct AddTime: View {
    ...
    func noti(year: Int, month: Int, day: Int, during: Int, islunar: String) {
        if during == 7{
        //打开通知
        let content = UNMutableNotificationContent()
        content.title = "【\(who)】将7天后到达[\(islunar)]计算节点，请及时做好安排"
        ...
        let request = UNNotificationRequest(identifier: "\(who)\(during)", content: content, trigger: trigger)
        UNUserNotificationCenter.current().add(request)
        } else if during == 3 {
            let content = UNMutableNotificationContent()
            content.title = "【\(who)】将3天后到达[\(islunar)]计算节点，请及时做好安排"
            content.sound = UNNotificationSound.defaultCritical
            var dateComponents = DateComponents()
            dateComponents.year = year
            dateComponents.month = month
            ...
            let content = UNMutableNotificationContent()
            content.title = "【\(who)】将明天到达[\(islunar)]计算节点，别忘记了"
            content.sound = UNNotificationSound.defaultCritical
            var dateComponents = DateComponents()
            dateComponents.year = year
            dateComponents.month = month
            ...
            let content = UNMutableNotificationContent()
            content.title = "【\(who)】今天已到[\(islunar)]计算节点！"
            content.sound = UNNotificationSound.defaultCritical
            var dateComponents = DateComponents()
            dateComponents.year = year
            dateComponents.month = month
    ...
    private func addnotification() {
        ...
        let dateday7 = Calendar.current.component(.day, from: notidate7! )
            noti(year: dateyear7, month: datemonth7, day: dateday7, during: 7, islunar: Islunar)
        ...
        let dateday3 = Calendar.current.component(.day, from: notidate3! )
            noti(year: dateyear3, month: datemonth3, day: dateday3, during: 3, islunar: Islunar)
        ...
        let dateday1 = Calendar.current.component(.day, from: notidate1! )
            noti(year: dateyear1, month: datemonth1, day: dateday1, during: 1, islunar: Islunar)
        ...
        let intyear = Calendar.current.component(.year, from: releaseDate )
        let intmonth = Calendar.current.component(.month, from: releaseDate )
        let intday = Calendar.current.component(.day, from: releaseDate )
        ...
        //相对阳历
        let solormonth = Calendar.current.component(.month, from: releaseDate )
        let solorday = Calendar.current.component(.day, from: releaseDate )
        let strrr = "\(yearfresh())年\(solormonth)月\(solorday)日"
        let relativedate = dateFormatter.date(from: strrr) ?? Date()

        //相对阴历
        let dateyear2 = Calendar.current.component(.year, from: releaseDate )
        let datemonth = Calendar.current.component(.month, from: releaseDate )
        let dateday = Calendar.current.component(.day, from: releaseDate )
        ...
        let lunarmonth = Int(lunarFormatter1.string(from: releaseDate))//阴历月份
        ...
        if intyear >= dateyear {
            print("大于等于本年")
            print("releaseDate为：\(releaseDate)")
            print("时间间隔：\(timefar(day: releaseDate))")
            if timefar(day: releaseDate) > 7 {
                print("大于7天")
                noti7(date: releaseDate, Islunar: "公历")
                noti3(date: releaseDate, Islunar: "公历")
                noti1(date: releaseDate, Islunar: "公历")
                noti(year: intyear, month: intmonth, day: intday, during: 0, islunar: "公历")
            } else if (3 < timefar(day: releaseDate)) && (timefar(day: releaseDate) < 7) {
                noti3(date: releaseDate, Islunar: "公历")
                noti1(date: releaseDate, Islunar: "公历")
                noti(year: intyear, month: intmonth, day: intday, during: 0, islunar: "公历")
            } else if (1 < timefar(day: releaseDate)) && (timefar(day: releaseDate) < 3) {
                noti1(date: releaseDate, Islunar: "公历")
                noti(year: intyear, month: intmonth, day: intday, during: 0, islunar: "公历")
            }
            ...
            if timefar(day: relativedate) > 7 {
                noti7(date: relativedate, Islunar: "每年公历")
                noti3(date: relativedate, Islunar: "每年公历")
                noti1(date: relativedate, Islunar: "每年公历")
                noti(year: yearfresh(), month: intmonth, day: intday, during: 0, islunar: "每年公历")
            } else if (3 < timefar(day: relativedate)) && (timefar(day: relativedate) < 7) {
                noti3(date: relativedate, Islunar: "每年公历")
                noti1(date: relativedate, Islunar: "每年公历")
                noti(year: yearfresh(), month: intmonth, day: intday, during: 0, islunar: "每年公历")
            ...
            if timefar(day: lunardate) > 7 {
                noti7(date: lunardate, Islunar: "每年农历")
                noti3(date: lunardate, Islunar: "每年农历")
                noti1(date: lunardate, Islunar: "每年农历")
                noti(year: solaryear as! Int, month: solarmonth as! Int, day: solarday as! Int, during: 0, islunar: "每年农历")
            } else if (3 < timefar(day: lunardate)) && (timefar(day: lunardate) < 7) {
                noti3(date: lunardate, Islunar: "每年农历")
                noti1(date: lunardate, Islunar: "每年农历")
                noti(year: solaryear as! Int, month: solarmonth as! Int, day: solarday as! Int, during: 0, islunar: "每年农历")
