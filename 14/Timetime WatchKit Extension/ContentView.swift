...
//                        .frame(width: WKInterfaceDevice.current().screenBounds.size.width/3.0, height: 65.0)
...
//
//
//let ratioyear = String(format: "%.2f", yearbug(year: yearfresh(), day: yeardayfresh(), hour: hourfresh()))lunarrr
