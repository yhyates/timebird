...
struct todoView: View {
    ...
    var body: some View {
        ...
        ZStack{
            ...
            .navigationBarTitle("📝Todo清单")

            ConfettiCannon(counter: $counter, num: 15,  confettis: [.text("🌟")], openingAngle: Angle(degrees: 40), closingAngle: Angle(degrees: 360), radius: 100, repetitions: 3, repetitionInterval: 0.1)
        }//zs
