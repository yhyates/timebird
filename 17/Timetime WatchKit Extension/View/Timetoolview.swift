...
struct timetool: View {
    ...
    var body: some View {
        ...
        ScrollView{
            ...
            Text(ischoosesolor ? "农历为：\("\(LunarCore.solarToLunar(intyear1,intmonth1,intday1)["GanZhiYear"]!)")\("\(LunarCore.solarToLunar(intyear1,intmonth1,intday1)["zodiac"]!)年")\("\(LunarCore.solarToLunar(intyear1,intmonth1,intday1)["lunarMonthName"]!)\("\(LunarCore.solarToLunar(intyear1,intmonth1,intday1)["lunarDayName"]!)")")⏎" : "公历为：\("\(LunarCore.lunarToSolar(intyear1,intmonth1,intday1)["year"]!)年")\("\(LunarCore.lunarToSolar(intyear1,intmonth1,intday1)["month"]!)月")\("\(LunarCore.lunarToSolar(intyear1,intmonth1,intday1)["day"]!)日")⏎")
                .font(.footnote)
            ...
            Text(ischoosesolor ? "公历为：\(dateFormatter.string(from: rightTime!))⏎" : "公历为：\(dateFormatter.string(from: rightTime2!))⏎")
                .font(.footnote)
                .foregroundColor(Color("cuteblue2"))


            Text(ischoosesolor ? "农历为：\("\(LunarCore.solarToLunar(Calendar.current.component(.year, from: rightTime! ),Calendar.current.component(.month, from: rightTime! ),Calendar.current.component(.day, from: rightTime! ))["GanZhiYear"]!)")\("\(LunarCore.solarToLunar(Calendar.current.component(.year, from: rightTime! ),Calendar.current.component(.month, from: rightTime! ),Calendar.current.component(.day, from: rightTime! ))["zodiac"]!)")年\("\(LunarCore.solarToLunar(Calendar.current.component(.year, from: rightTime! ),Calendar.current.component(.month, from: rightTime! ),Calendar.current.component(.day, from: rightTime! ))["lunarMonthName"]!)")\("\(LunarCore.solarToLunar(Calendar.current.component(.year, from: rightTime! ),Calendar.current.component(.month, from: rightTime! ),Calendar.current.component(.day, from: rightTime! ))["lunarDayName"]!)")⏎" : "农历为：\("\(LunarCore.solarToLunar(Calendar.current.component(.year, from: rightTime2! ),Calendar.current.component(.month, from: rightTime2! ),Calendar.current.component(.day, from: rightTime2! ))["GanZhiYear"]!)")\("\(LunarCore.solarToLunar(Calendar.current.component(.year, from: rightTime2! ),Calendar.current.component(.month, from: rightTime2! ),Calendar.current.component(.day, from: rightTime2! ))["zodiac"]!)")年\("\(LunarCore.solarToLunar(Calendar.current.component(.year, from: rightTime2! ),Calendar.current.component(.month, from: rightTime2! ),Calendar.current.component(.day, from: rightTime2! ))["lunarMonthName"]!)")\("\(LunarCore.solarToLunar(Calendar.current.component(.year, from: rightTime2! ),Calendar.current.component(.month, from: rightTime2! ),Calendar.current.component(.day, from: rightTime2! ))["lunarDayName"]!)")⏎")
                .font(.footnote)
